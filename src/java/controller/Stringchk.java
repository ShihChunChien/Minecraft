...
public class Stringchk {
    ...
    public static String regex() {
        ...
        if(emailin == null){ inputEmailStr = "null";}else{ inputEmailStr = emailin;}
        ...
        if(usernamein == null){ inputUsernameStr = "@null";}else{ inputUsernameStr = usernamein;}
        ...
        if(matchMailFound == true){outstring = "true";} else if(matchUsernameFound == true){outstring = "true";} else{outstring = "false";}
     ...
     public static void main(String[] args) { System.out.println(regex());}
}